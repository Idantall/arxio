...
export const metadata: Metadata = {
  title: "התחברות - ARXIO",
  description: "התחברות לחשבון ARXIO שלך",
};

export default function LoginPage() {
  return (
    <div className="relative min-h-screen flex items-center justify-center bg-gradient-to-b from-gray-900 to-gray-800 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8 bg-white dark:bg-gray-900 p-8 rounded-xl shadow-2xl">
        ...
        <div className="mt-6">
          <a href="/api/auth/signin/github" className="w-full block">
            <button
